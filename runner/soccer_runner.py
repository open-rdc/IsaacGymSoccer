...
class SoccerRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                obs, share_obs, rewards, dones, infos, available_actions, c_obs, c_share_obs, c_rewards, c_dones, c_infos, c_available_actions = self.envs.step(concat_actions)
                self.envs.reset()
                ...
                c_data = c_obs, c_share_obs, c_rewards, c_dones, c_infos, c_available_actions, \
            ...
            if (episode % self.self_play_interval == 0 and episode > self.save_interval):
                ...
                self.c_restore(str(self.save_dir) + "/transformer_" + str(episode) + ".pt")
    ...
    def warmup(self):
        # reset env
        self.envs.reset_buf.fill_(1)
        obs, share_obs, ava, c_obs, c_share_obs, c_ava = self.envs.reset()
        ...
        self.c_buffer.available_actions[0] = c_ava.copy()
