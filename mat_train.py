...
def parse_args(args, parser):
    ...
    parser.add_argument('--self_play_interval', type=int, default=100, help="number of switching episodes for self-play")
